<div class="row text-left p-3 legal-adults">
    ...
    <div class="col-md-12 form-group">
        <?php echo Form::label('over_eighteen', 'Are you over the age of 18?', ['class' => 'required-star']); ?> <br>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <?php echo Form::label('imageFileOfId', "Submit form of ID: Passport or Driver’s Licence for Proof of Age", ['class' => 'required-star']); ?>

            <br>
            <img class="border border-primary img-view imageFileOfId" src="<?php echo e(url('img/photo.png')); ?>" height="250" width="100%" style="cursor: pointer" />
    ...
    <div class="col-md-6">
        <div class="form-group">
            <?php echo Form::label('imageBackOfId', 'We must also have a picture of the back of your ID', ['class' => 'required-star']); ?>

            <br>
            <img class="border border-primary img-view imageBackOfId" src="<?php echo e(url('img/photo.png')); ?>" height="250" width="100%" style="cursor: pointer" />
            <label class="btn btn-block btn-secondary btn-sm rounded-0" style="cursor: pointer">
        ...
        <?php /**PATH /home/mytopten/model.alluringintros.eu/resources/views/layouts/includes/three-step.blade.php ENDPATH**/ ?>