<?php $__env->startSection('header-css'); ?>
    <?php echo Html::style('/assets/backend/dist/css/custom-design.css'); ?>

    <?php echo Html::style('/assets/backend/plugins/multistep-form/multi-form.css'); ?>

    <?php echo Html::style('/assets/login/css/icofont.min.css'); ?>

    <?php echo Html::style('/assets/login/css/site-flaticon.css'); ?>

    <?php echo Html::style('/assets/backend/dist/css/dropzone.min.css'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="col-md-8 mx-auto">
        ...
        <?php echo Form::open(['route' => 'document.submit', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'class' => 'dataForm', 'id' => 'myForm']); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mx-auto mt-3">
                        <div class="tab general-info-tab" active-tab="general-info">
                            <?php echo $__env->make("layouts.includes.one-step", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <div class="tab ssc-tab" active-tab="ssc-level">
                            <?php echo $__env->make("layouts.includes.two-step", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <div class="tab hsc-tab" active-tab="hsc-level">
                            <?php echo $__env->make("layouts.includes.three-step", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <div class="tab bachelor-tab" active-tab="bachelor-degree">
                            <?php echo $__env->make("layouts.includes.four-step", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <div class="tab master-tab" active-tab="master-degree">
                            <?php echo $__env->make("layouts.includes.five-step", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <div class="tab english-language-tab" active-tab="english-language">
                            <?php echo $__env->make("layouts.includes.six-step", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <div class="tab" active-tab="testimonial">
                            <?php echo $__env->make('layouts.includes.seven-step', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <div class="tab" active-tab="interested-country">
                            <?php echo $__env->make('layouts.includes.eight-step', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <div class="tab" active-tab="last-one-step">
                            <?php echo $__env->make('layouts.includes.nine-step', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->startSection('footer-script'); ?>
    <?php echo Html::script('/assets/backend/plugins/multistep-form/multi-form-create.js'); ?>

    <?php echo Html::script('js/signature_pad.min.js'); ?>

    <?php echo Html::script('/assets/backend/dist/js/image-uploader.min.js'); ?>
    ...
    <script type="text/javascript">
        ...
        *********************************/
        ...
        $("#gender").on('change', function(){
            ...
            if($(this).val() == "Male" || $(this).val() == "Transgender Male") {
                $("#cup_size").val("N/A");
                $("#cup_size").attr('readonly', true);
                $("#hips").val("N/A");
                $("#hips").attr('readonly', true);
                 $("#bust_size").val("N/A");
                $("#bust_size").attr('readonly', true);
                
                 $("#waist").val("N/A");
                $("#waist").attr('readonly', true);
            } else {
                $("#cup_size").val("");
                $("#cup_size").attr('readonly', false);
                $("#hips").val("");
                $("#hips").attr('readonly', false);
                 $("#bust_size").val("");
                $("#bust_size").attr('readonly', false);
                
                 $("#waist").val("");
                $("#waist").attr('readonly', false);
            }
        })
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mytopten/model.alluringintros.eu/resources/views/index.blade.php ENDPATH**/ ?>